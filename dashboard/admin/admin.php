    ...
    try {
        switch ($_POST['action']) {
            case 'create':
                ...
                if ($result) {
                    echo json_encode(['status' => 'success', 'message' => 'Administrator berhasil ditambahkan!']);
                } else {
                    echo json_encode(['status' => 'error', 'message' => 'Gagal menambahkan administrator.']);
                }
                break;
            ...
            case 'update':
                ...
                if ($result) {
                    echo json_encode(['status' => 'success', 'message' => 'Administrator berhasil diupdate!']);
                } else {
                    echo json_encode(['status' => 'error', 'message' => 'Gagal mengupdate administrator.']);
                }
                break;
            ...
            case 'delete':
                ...
                if ($result) {
                    echo json_encode(['status' => 'success', 'message' => 'Administrator berhasil dihapus!']);
                } else {
                    echo json_encode(['status' => 'error', 'message' => 'Gagal menghapus administrator.']);
                }
                break;
            ...
            // Remove profile update handler - it's now handled by profile_handler.php
            default:
...
<head>
    ...
    <title>Kantor Camat Sutera - Data Admin</title>
                ...
                <div class="page-inner">
                    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                        <div>
                            ...
                            <h6 class="op-7 mb-2">Kelola Data Administrator</h6>
                        </div>
