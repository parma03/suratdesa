    ...
    try {
        switch ($_POST['action']) {
            ...
            case 'update':
                ...
                if ($result) {
                    echo json_encode(['status' => 'success', 'message' => 'Masyarakat berhasil diupdate!']);
                } else {
                    echo json_encode(['status' => 'error', 'message' => 'Gagal mengupdate masyarakat.']);
                }
                break;
            ...
            case 'delete':
                ...
                if ($result) {
                    echo json_encode(['status' => 'success', 'message' => 'Masyarakat berhasil dihapus!']);
                } else {
                    echo json_encode(['status' => 'error', 'message' => 'Gagal menghapus masyarakat.']);
                }
                break;
...
// Fetch all data
$stmt = $pdo->prepare("SELECT * FROM tb_user WHERE role = 'Masyarakat' ORDER BY created_at DESC");
$stmt->execute();
$data = $stmt->fetchAll();
?>
<!DOCTYPE html>
            ...
            <div class="container">
                <div class="page-inner">
                    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                        <div>
                            <h3 class="fw-bold mb-3">Masyarakat</h3>
                            <h6 class="op-7 mb-2">Kelola Data Masyarakat</h6>
                        </div>
