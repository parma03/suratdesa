...
// Build the query
$whereClause = "WHERE p.status_permohonan = 'diverifikasi'";
$params = [];
...
if (isset($_GET['export']) && $_GET['export'] == 'excel') {
    ...
    echo '<div class="sub-header">Status: DIVERIFIKASI</div>';
    if ($periodStr) {
    ...
    <div id="printable-content" style="display: none;">
        ...
        <div class="print-info">
            <div class="left-info">
                ...
                Status Permohonan: <strong>DIVERIFIKASI</strong><br>
            ...
            <div class="summary-box">
                ...
                <div class="summary-content">
                    ...
                    <div class="summary-right">
                        <strong>Status:</strong> Diverifikasi<br>
                        <?php if (!empty($kategori)): ?>
                ...
                <div class="page-inner">
                    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                        <div>
                            ...
                            <h6 class="op-7 mb-2">Laporan Data Permohonan dengan Status Diverifikasi</h6>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="d-flex align-items-center">
                                        <h4 class="card-title">Data Permohonan - Status Diverifikasi</h4>
                                        <div class="ms-auto">
                                            <?php if (!empty($tanggal_mulai) && !empty($tanggal_selesai)): ?>
